...
/**
 * shadcn/ui Table, adapted for this project: Tailwind v3 (no v4-only
 * `has-*` variants) and Vite (no "use client" directive).
 */
/**
 * `containerClassName` styles the scroll wrapper — needed to cap height so a
